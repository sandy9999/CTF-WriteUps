We are given this piece of encrypted text.
...
Clearly the decryption of `hgqqpohzCZK{m311a50_0x_a1rn3x3_h1ah3x54ioc1h9}` is what we need. This is a vigenere cipher. We can use this [tool](https://www.guballa.de/vigenere-solver) to break it. Here is our decrypted text.
